...
1. Run `/jai-dev:02-implement`.

```text
/jai-dev:02-implement
```
...
1. Run `/jai-vcs:02-pull-request`.

```text
/jai-vcs:02-pull-request
```

> One command for the whole loop: `/jai-orchestrator:01-sdlc` runs frame when needed → plan → implement → validate → review → challenge → ship.
