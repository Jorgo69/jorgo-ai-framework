...
> Prefer a guided walkthrough? `/jai-context:00-onboard` inspects your project and routes you step by step instead of running the sequence by hand.
...
1. Run `/jai-refine:01-brainstorm`.

```text
/jai-refine:01-brainstorm
```
...
1. Run `/jai-pm:06-product-brief`.
2. Pass its brief to `/jai-pm:03-prd`.

```text
/jai-pm:06-product-brief
/jai-pm:03-prd
```
...
1. Run `/jai-context:01-bootstrap`.

```text
/jai-context:01-bootstrap
```
...
1. Run `/jai-context:02-project-memory`.

```text
/jai-context:02-project-memory
```
...
Use `/jai-context:00-onboard` any time to see where the project sits.
